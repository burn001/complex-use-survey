      ...
      <div class="survey-container">
        ...
        <div class="access-denied">
          ...
          <p class="access-denied-msg">
            본 전문가 조사는 목표 응답 수에 도달하여 2026년 8월 21일자로 마감되었습니다.<br/>
    ...
    this.container.innerHTML = `
      ...
      <div class="survey-container with-status-bar">
        <div class="completion">
          ...
          <h2>설문이 완료되었습니다</h2>
          <p>제1차 조사에 응해 주셔서 진심으로 감사드립니다.<br/>
          수집된 결과는 통계 요약되어 2라운드(본인 응답 위치와 집단 분포 제공)에 활용되며, 용도전환·적응형 설계기준 마련의 근거자료가 됩니다.</p>
          ${alreadyMsg}
